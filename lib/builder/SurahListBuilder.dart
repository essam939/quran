          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) => ListTile(
                  title: Text(surah[index].titleAr,style: TextStyle(color: Colors.white),),
                  subtitle: Text(surah[index].title,style: TextStyle(color: Colors.white),),
                  leading: Image(
                      image:
                          AssetImage("assets/images/${surah[index].place}.png"),
                      width: 30,
                      height: 30),
                  trailing: Text("${surah[index].pageIndex}",style: TextStyle(color: Colors.grey),),
                  onTap: () {
